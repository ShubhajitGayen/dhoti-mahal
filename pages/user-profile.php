...
<div class="profile-layout">
    ...
    <div class="profile-content">
            ...
            <table class="orders-table">
                ...
                <?php foreach ($orders as $order): ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= BASE_URL ?>pages/track-order.php?order=<?= urlencode($order['order_number']) ?>" style="color:var(--crimson);font-size:13px;font-weight:600;">
        ...
        <h2>Edit Profile</h2>
        <?php if ($saved): ?>
            <div class="flash-message flash-success" style="border-radius:4px;padding:12px 16px;margin-bottom:16px;">Profile updated successfully!</div>
        <?php endif; ?>
        <?php if (!empty($errors)): ?>
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <input type="email" value="<?= sanitize($user['email']) ?>" disabled style="background:var(--cream);">
            </div>
            <div class="form-group">
                <label>Default Delivery Address</label>
                <textarea name="address" rows="2" placeholder="House/Flat, Street, Area"><?= sanitize($user['address'] ?? '') ?></textarea>
            </div>
            <div class="form-row">
                <div class="form-group">
                    <label>City</label>
        ...
        <?php if ($pwdSaved): ?>
            <div class="flash-message flash-success" style="border-radius:4px;padding:12px 16px;margin-bottom:16px;">Password changed successfully!</div>
        <?php endif; ?>
